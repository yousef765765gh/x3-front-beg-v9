...
const DashBordSecWork = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setFormData({ id: '', title: '', description: '', image: '', name: '', link: '', icon: '',name:'' })
    };
            ...
            <section className='dashboard-container'>
                ...
                <div>
                    <form onSubmit={handleSubmit} className='form'>
                        ...
                        {isEditing && (
                            <button type="button" onClick={() => { setIsEditing(false); setFormData({ id: '', title: '', description: '', image: '', name: '', link: '', icon: '',name:'' }) }} >
                                exit
                            </button>
                        )}
                    </form>
